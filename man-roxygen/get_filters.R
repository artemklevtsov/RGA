...
#' @param filter.id character. Filter ID to retrieve filters for.
...
#' \item{parent.link}{Parent link for this filter. Points to the account to which this filter belongs.}
