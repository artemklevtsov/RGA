...
#' @param accountId character. Account ID to retrieve the experiment for.
#' @param experimentId character. Experiment ID to retrieve the experiment for.
#' @param profileId character. View (Profile) ID to retrieve the experiment for.
#' @param webPropertyId character. Web property ID to retrieve the experiment for.
...
#' \item{accountId}{Account ID to which this experiment belongs. This field is read-only.}
#' \item{webPropertyId}{Web property ID to which this experiment belongs. The web property ID is of the form UA-XXXXX-YY. This field is read-only.}
#' \item{internalWebPropertyId}{Internal ID for the web property to which this experiment belongs. This field is read-only.}
#' \item{profileId}{View (Profile) ID to which this experiment belongs. This field is read-only.}
...
#' \item{objectiveMetric}{The metric that the experiment is optimizing.  Valid values: "ga:goal(n)Completions", "ga:adsenseAdsClicks", "ga:adsenseAdsViewed", "ga:adsenseRevenue", "ga:bounces", "ga:pageviews", "ga:sessionDuration", "ga:transactions", "ga:transactionRevenue". This field is required if status is "RUNNING" and servingFramework is one of "REDIRECT" or "API".}
#' \item{optimizationType}{Whether the objectiveMetric should be minimized or maximized. Possible values: "MAXIMUM", "MINIMUM". Optional--defaults to "MAXIMUM".  Cannot be specified without objectiveMetric. Cannot be modified when status is "RUNNING" or "ENDED".}
...
#' \item{winnerFound}{Boolean specifying whether a winner has been found for this experiment. This field is read-only.}
#' \item{startTime}{The starting time of the experiment (the time the status changed from READY_TO_RUN to RUNNING). This field is present only if the experiment has started. This field is read-only.}
#' \item{endTime}{The ending time of the experiment (the time the status changed from RUNNING to ENDED). This field is present only if the experiment has ended. This field is read-only.}
#' \item{reasonExperimentEnded}{Why the experiment ended. Possible values: "STOPPED_BY_USER", "WINNER_FOUND", "EXPERIMENT_EXPIRED", "ENDED_WITH_NO_WINNER", "GOAL_OBJECTIVE_CHANGED".  "ENDED_WITH_NO_WINNER" means that the experiment didn't expire but no winner was projected to be found. If the experiment status is changed via the API to ENDED this field is set to STOPPED_BY_USER. This field is read-only.}
#' \item{rewriteVariationUrlsAsOriginal}{Boolean specifying whether variations URLS are rewritten to match those of the original. This field may not be changed for an experiment whose status is ENDED.}
#' \item{winnerConfidenceLevel}{A floating-point number between 0 and 1. Specifies the necessary confidence level to choose a winner. This field may not be changed for an experiment whose status is ENDED.}
#' \item{minimumExperimentLengthInDays}{An integer number in [3, 90]. Specifies the minimum length of the experiment. Can be changed for a running experiment. This field may not be changed for an experiment whose status is ENDED.}
#' \item{trafficCoverage}{A floating-point number between 0 and 1. Specifies the fraction of the traffic that participates in the experiment. Can be changed for a running experiment. This field may not be changed for an experiment whose status is ENDED.}
